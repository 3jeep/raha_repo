          ...
          children: [
            GoogleMap(
              ...
              onMapCreated: (controller) async {
                ...
                if(mounted) _mapController?.showMarkerInfoWindow(const MarkerId('user_loc'));
                for (var h in _handymen) {
                 if(mounted) _mapController?.showMarkerInfoWindow(MarkerId(h['id']));
                }
              },
              markers: markers,
            ...
            if (_locationMsg.isNotEmpty)
              Positioned(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(color: Colors.black.withAlpha(217), borderRadius: BorderRadius.circular(15)),
            ...
            Row(
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(color: isBusy ? Colors.red.withAlpha(26) : Colors.green.withAlpha(26), borderRadius: BorderRadius.circular(20)),
