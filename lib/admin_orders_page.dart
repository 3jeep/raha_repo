...
class _MonthlyContractsPageState extends State<MonthlyContractsPage> {
    ...
    return Padding(
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(20), border: Border.all(color: Colors.blue.withAlpha(25))),
          child: Row(children: [
  ...
  Widget _buildContractCard(Map<String, dynamic> b) {
    return Container(
      ...
      decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(40), border: Border.all(color: Colors.blue[50]!), boxShadow: [BoxShadow(color: Colors.black.withAlpha(12), blurRadius: 20)]),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        if (_visitsData[b['id']] != null && _visitsData[b['id']]!.isNotEmpty) ...[
          ...
          SizedBox(height: 65, child: ListView.builder(scrollDirection: Axis.horizontal, itemCount: _visitsData[b['id']]!.length, itemBuilder: (context, i) {
            ...
            return Container(width: 90, margin: const EdgeInsets.only(left: 8), padding: const EdgeInsets.all(10), decoration: BoxDecoration(color: Colors.blue[50]?.withAlpha(127), borderRadius: BorderRadius.circular(15), border: Border.all(color: Colors.blue[100]!)), child: Column(children: [
  ...
  void _handleStart(Map b) async {
    if (b['assignedMaid'] == null || b['assignedVehicle'] == null) {
      if(mounted) ScaffoldMessenger.of(context).showSnackBar(const SnackBar(backgroundColor: Colors.red, content: Text("⚠️ يرجى تعيين الفريق أولاً")));
      return;
    }
