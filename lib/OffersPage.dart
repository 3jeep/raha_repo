          ...
          child: Column(
            ...
            children: [
              ...
              Text("جاري تحضير قائمة الخدمات...", 
                style: TextStyle(fontFamily: 'Cairo', fontWeight: FontWeight.w900, color: const Color(0xFF1E293B).withOpacity(0.5), fontStyle: FontStyle.italic)),
            ],
          ),
        ),
      );
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [BoxShadow(color: Colors.blueGrey.withOpacity(0.05), blurRadius: 15, offset: const Offset(0, 10))],
        ),
        child: Row(
          children: [
            Stack(
              children: [
                ...
                if (isLocked)
                  Positioned.fill(
                    child: Container(
                      decoration: BoxDecoration(color: const Color(0xFF1E293B).withOpacity(0.6), borderRadius: BorderRadius.circular(30)),
