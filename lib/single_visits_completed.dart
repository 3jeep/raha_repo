              ...
              Expanded(
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(color: _isFilteredByDate ? Colors.blue.withAlpha(26) : Colors.grey[100], borderRadius: BorderRadius.circular(10)),
  ...
  void _confirmDelete(String id) {
    showDialog(
      ...
      builder: (dContext) => AlertDialog(
        ...
        actions: [
          TextButton(onPressed: () => Navigator.pop(dContext), child: const Text("تراجع")),
          ElevatedButton(
