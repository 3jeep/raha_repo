  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        actions: [IconButton(onPressed: _fetchCompletedVisits, icon: const Icon(Icons.refresh))],
      ),
      body: Directionality(
  ...
  Widget _buildVisitCard(Map v) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: Colors.black.withAlpha(7), blurRadius: 10)],
      ),
      child: Column(
      ...
      builder: (dContext) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              await _db.collection('contracts').doc(visit['contractId']).collection('visits').doc(visit['visitId']).delete();
