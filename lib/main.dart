...
import 'SingleVisitPage.dart'; 
import 'MyBookingsPage.dart';      
import 'LoginPage.dart';
import 'OffersPage.dart';
import 'ProfilePage.dart';
import 'LaundryCheckoutPage.dart'; 
import 'SpecialOfferCheckoutPage.dart'; 
import 'MultiVisitContractPage.dart'; 
          ...
          Positioned(
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    const CircleAvatar(backgroundColor: Color(0xFFEEF2FF), radius: 25, child: Icon(Icons.engineering_rounded, color: Colors.blue)),
                    ...
                    Container(
                      ...
                      child: const Text(" 100% مجاني ", style: TextStyle(color: Colors.black, fontSize: 9, fontWeight: FontWeight.w900)),
                    ),
        ...
        children: [
          ...
          if (_isAdmin) ...[
            _modernServiceCard(
              ...
              "🛰️ تتبع الطلبات وإدارة العمليات لـ (${_adminType == 'super' ? 'الكل' : _adminType == 'cleaning' ? 'النظافة' : 'الغسيل'})", 
              ...
              decoration: BoxDecoration(
                image: imageUrl != null ? DecorationImage(
                  ...
                  colorFilter: ColorFilter.mode(
                    isLocked ? Colors.black.withOpacity(0.7) : Colors.black.withOpacity(0.45), 
                    BlendMode.darken
                  ),
                ) : null,
                ...
                boxShadow: [
                  BoxShadow(
                    color: isLocked ? Colors.black12 : Colors.blue.withOpacity(0.3),
                    blurRadius: 10,
